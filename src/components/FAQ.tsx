...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'No. Our Nero Engine uses multiple AI tools for market research, content creation, ad optimisation, and performance tracking. But every strategy is designed and approved by experienced humans. AI makes us faster and smarter — it does not replace thinking. You get the speed of AI with the judgment of real strategists.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Your complete system is built and running. Most clients move to our Active Presence plan to keep content flowing and ads optimising. The machine is built — we keep it running and improving. Most clients see ROI within the Sprint itself.',
  },
  {
    question: 'What if I already have a brand and website?',
    answer: "We will audit everything first. If your existing brand and website are solid, we skip that phase and focus your budget on content and ads instead. If something needs fixing, we will tell you honestly. The Sprint adapts to what you actually need — no unnecessary work.",
  },
  {
            ...
            <motion.div
              ...
              className={`border-2 ${
                openIndex === index
                  ...
                  : 'border-zinc-700 bg-white/[0.02] hover:bg-white/[0.04]'
              } transition-all duration-300 overflow-hidden relative group rounded-none`}
            >
              {/* Hover gradient */}
              <div
                className={`absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent pointer-events-none opacity-0 ${
                  openIndex !== index ? 'group-hover:opacity-100' : ''
              ...
              >
                <h3 className="text-base font-bold uppercase pr-4 group-hover:translate-x-[4px] transition-transform duration-200">
                  {item.question}
                </h3>
                <div
