...
export const portfolioRecords: PortfolioRecord[] = [
  ...
  },
  {
    ...
    image: '/websites/pareero-live/home-desktop.jpg',
    imageAlt: 'Current PAREERO Shopify storefront and product discovery experience',
  ...
  },
  {
    ...
    verifiedFacts: ['Built from scratch by NEROZARB', 'Public production website', '100K+ matched campaign reach', '10K+ campaign engagement over 60 days'],
