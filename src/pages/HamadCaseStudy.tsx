...
const HamadCaseStudy: React.FC = () => {
  ...
  const sprintContactHref = buildContactHref(
    "Hi NEROZARB, I'm interested in the 60-Day Sprint after seeing the Hamad Foundation case study.",
    'Hamad Foundation sprint inquiry'
  );
      ...
      <div className="max-w-[1200px] mx-auto relative z-10 w-full mb-20 shadow-2xl bg-onyx/50 backdrop-blur-sm border border-white/5 mt-10">
        ...
        <header className="relative p-10 md:p-[80px_80px_60px] border-b border-white/5 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
          <div>
            ...
            <div className="font-display text-[13px] font-black tracking-[0.25em] text-platinum uppercase">NEROZARB × HAMAD FOUNDATION</div>
          </div>
        ...
        <div className="relative p-10 md:p-[100px_80px_80px] border-b border-white/5">
          ...
          <motion.h1 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} transition={{ delay: 0.15 }} className="font-display font-black text-[clamp(46px,6.5vw,88px)] leading-[0.95] uppercase tracking-normal max-w-[860px] mb-10">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} transition={{ delay: 0.4 }} className="flex flex-col sm:flex-row gap-[1px] max-w-[640px] bg-white/5 border border-white/5 mb-14">
            <div className="bg-onyx p-6 md:px-7 md:py-6 flex-1 transition-colors hover:bg-white/5">
              ...
              <div className="font-display font-black text-[15px] uppercase mb-1.5">YC Educational Services</div>
            ...
            <div className="bg-onyx p-6 md:px-7 md:py-6 flex-1 transition-colors hover:bg-white/5">
              ...
              <div className="font-display font-black text-[15px] uppercase mb-1.5">Hamad Foundation</div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} transition={{ delay: 0.5 }} className="grid grid-cols-2 md:grid-cols-4 gap-[1px] bg-white/5 border border-white/5 max-w-[860px]">
            {[
              ...
              <div key={i} className="bg-onyx p-6 md:px-7 md:py-8 transition-colors hover:bg-[rgba(63,106,36,0.05)]">
                <div className="font-display font-black text-4xl text-white leading-none mb-1.5 tracking-normal">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} transition={{ delay: 0.58 }} className="mt-6 grid max-w-[860px] grid-cols-1 gap-[1px] border border-olive/25 bg-olive/20 md:grid-cols-[1.2fr_1fr_1fr]">
            <div className="bg-onyx p-5">
              <div className="mb-1 font-mono text-[10px] uppercase text-olive">Project investment</div>
              <div className="text-[14px] text-white/70">60-Day Sprint equivalent for two identities, two websites, social setup, and donation-ready infrastructure.</div>
            </div>
            <div className="bg-onyx p-5">
        ...
        <section className="relative p-10 md:p-20 border-b border-white/5">
          ...
          <h2 className="font-display font-black text-[clamp(26px,3.2vw,42px)] uppercase tracking-normal leading-[1.05] mb-7 max-w-[700px]">AN NGO WITH<br/>NO DIGITAL IDENTITY.</h2>
        ...
        <section className="relative p-10 md:p-20 border-b border-white/5">
          ...
          <h2 className="font-display font-black text-[clamp(26px,3.2vw,42px)] uppercase tracking-normal leading-[1.05] mb-7 max-w-[700px]">ONE FAMILY.<br/>TWO DISTINCT IDENTITIES.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[1px] bg-white/5 border border-white/5">
            ...
            <div className="bg-onyx p-8 md:px-10 md:py-12 relative overflow-hidden transition-colors hover:bg-[rgba(63,106,36,0.04)] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[3px] before:bg-olive before:opacity-50">
              ...
              <div className="font-display font-black text-[22px] uppercase tracking-[0.02em] mb-5 leading-[1.15]">YC Educational<br/>Services</div>
              ...
              <div className="mt-8">
                 <span className="inline-block text-[10px] font-mono uppercase border border-olive/60 text-olive px-4 py-2">WEBSITE DELIVERED</span>
              </div>
            </div>
            {/* Child */}
            <div className="bg-onyx p-8 md:px-10 md:py-12 relative overflow-hidden transition-colors hover:bg-[rgba(63,106,36,0.04)] before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[3px] before:bg-olive before:opacity-50">
              <div className="font-mono text-[9px] tracking-[0.2em] text-olive uppercase mb-4">CHILD NGO</div>
              <div className="font-display font-black text-[22px] uppercase tracking-[0.02em] mb-5 leading-[1.15]">Hamad<br/>Foundation</div>
              <ul className="flex flex-col gap-3">
                {[
              ...
              <div className="mt-8">
                 <span className="inline-block text-[10px] font-mono uppercase bg-olive text-white px-4 py-2">WEBSITE DELIVERED</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative p-10 md:p-20 border-b border-white/5">
          ...
          <h2 className="font-display font-black text-[clamp(26px,3.2vw,42px)] uppercase tracking-normal leading-[1.05] mb-7 max-w-[700px]">EVERY SYSTEM.<br/>ONE SPRINT.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-white/5 border border-white/5">
            {[
              ...
              <div key={i} className="bg-onyx p-10 md:px-8 md:py-10 relative overflow-hidden transition-colors hover:bg-[rgba(63,106,36,0.05)]">
                <div className="font-display font-black text-[56px] text-[rgba(63,106,36,0.13)] leading-none absolute top-[18px] right-[22px] tracking-normal">{d.num}</div>
                <div className="font-mono text-[10px] tracking-[0.15em] text-olive uppercase mb-3.5 relative z-10">{d.icon}</div>
                <div className="font-display font-black text-[17px] uppercase tracking-[0.02em] mb-3 leading-[1.2] relative z-10">{d.title}</div>
        ...
        <section className="relative p-10 md:p-20 border-b border-white/5">
          ...
          <h2 className="font-display font-black text-[clamp(26px,3.2vw,42px)] uppercase tracking-normal leading-[1.05] mb-7 max-w-[700px]">THE SCOPE<br/>IN NUMBERS.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12">
            {[
              ...
              <div key={i} className="p-8 md:px-9 md:py-10 border border-white/5 relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-[3px] before:h-full before:bg-olive before:opacity-60 bg-onyx/30">
                <div className="font-display font-black text-[48px] leading-none tracking-normal mb-2">{block.num}<span className="text-olive">{block.accent}</span></div>
        ...
        <section className="relative p-10 md:p-20 border-b border-white/5">
          ...
          <h2 className="font-display font-black text-[clamp(26px,3.2vw,42px)] uppercase tracking-normal leading-[1.05] mb-7 max-w-[700px]">PHASE 2:<br/>THE CAMPAIGN IS LIVE.</h2>
          ...
          <div className="bg-[rgba(63,106,36,0.05)] border border-[rgba(63,106,36,0.25)] p-10 md:p-[52px_60px] relative overflow-hidden">
            ...
            <div className="absolute -right-5 top-1/2 -translate-y-1/2 rotate-90 font-display font-black text-[80px] text-[rgba(63,106,36,0.07)] tracking-[0.1em] pointer-events-none select-none">PHASE 2</div>
            ...
            <div className="font-display font-black text-[clamp(22px,2.8vw,36px)] uppercase tracking-normal leading-[1.1] mb-5 max-w-[600px] relative z-10">DESIGNED. PLANNED.<br/>READY TO SCALE.</div>
        ...
        <div className="bg-[rgba(63,106,36,0.04)] border-l-[3px] border-olive p-10 md:p-[52px_80px]">
          <div className="font-display font-black text-[clamp(18px,2.2vw,28px)] uppercase leading-[1.25] max-w-[760px] tracking-normal mb-5 text-white">
        ...
        <section className="relative p-10 md:p-20 border-b border-white/5">
          ...
          <h2 className="font-display font-black text-[clamp(26px,3.2vw,42px)] uppercase tracking-normal leading-[1.05] mb-7 max-w-[700px]">WHAT THIS PROVES<br/>FOR YOUR ORGANISATION.</h2>
        ...
        <div className="p-10 md:p-20 flex flex-col md:flex-row md:justify-between md:items-end gap-10 bg-onyx/50">
          <div>
            ...
            <div className="font-display font-black text-[clamp(22px,2.8vw,38px)] uppercase tracking-normal leading-[1.1] max-w-[460px] mb-5">BRAND BUILT.<br/>SYSTEM READY.<br/>YOUR TURN.</div>
          ...
          <div className="md:text-right">
            <div className="font-display font-black text-[26px] tracking-[0.1em] uppercase text-white">NEROZARB</div>
